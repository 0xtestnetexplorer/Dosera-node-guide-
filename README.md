...
* 4 GB RAM
* 20 GB Disk Space
* Get started with a low-budget `VPS` for as low as $5! [Purchase from xorec](https://my.xorek.cloud/)
...
* Method 1: [Install using Docker](https://github.com/0xtestnetexplorer/Dosera-node-guide-/blob/main/README.md#method-1-docker)
* Method 2: [Install using SystemD](https://github.com/0xtestnetexplorer/Dosera-node-guide-/blob/main/README.md#method-2-systemd)
